...
<body>
    <div class="form-container" id="form-container">
        <h2>Data Form</h2>
        <form method="post" action="data/post.php">
            <!-- First Name -->
            ...
            <div class="form-group">
                ...
                <input type="email" id="email" name="email" maxlength="50" pattern="[^@\s]+@[^@\s]+\.[^@\s]+" required>
            </div>
    ...
    <script>
        $('#sbmt-btn').click(function () => $('#form-container').html('ADDITIONAL DATA');)  {)
    </script>
</body>
</html>
